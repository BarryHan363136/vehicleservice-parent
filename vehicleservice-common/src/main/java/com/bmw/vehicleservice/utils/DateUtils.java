...
public class DateUtils {
    ...
    public static final FastDateFormat DATETIME_FORMAT_SS = FastDateFormat.getInstance("yyyy-MM-dd HH:mm:ss SS");
    ...
    public static final int secondsBetween(String beforeTime, String currTime) {
        ...
        try {
            ...
            logger.error("secondsBetween error{} ", e);
        }
    ...
    public static boolean compareTwoDate(String date1, String date2) {
        ...
        try {
            ...
            logger.error("compareTwoDate error{} ", e);
        }
    ...
    public static Long getBetweenDays(String date1, String date2) {
        ...
        try {
            ...
            logger.error("getBetweenDays error{} ", e);
        }
    ...
    public static String getCurrTime() {
        ...
        try {
            ...
            logger.error("getCurrTime error{} ", e);
        }
        return strTime;
    }
    ...
    public static long formatStringToLong(String timestr) {
        ...
        try {
            ...
            logger.error("formatStringToLong error{} ", e);
        }
        return time;
    }
